...
import { selectAllProducts,fetchProductByFiltersAsync,selectTotalItems } from "../ProductSlice";
...
useEffect(()=>{
  ...
  dispatch(fetchProductByFiltersAsync({filterr,sort,pagination}));
},[dispatch,filterr,sort,page]);
